...
public class AvifDecoder {
     ...
     * 
     * @参数 Array<UInt8> avif文件的字节数组信息
     * @返回值 Info 自定义类 里面包含avif的图像的一些信息如 width height depth alphaPresent frameCount repetitionCount frameDurations
     */
...
public struct Info {
    ...
    public var frameDurations: CPointer<Float64> = CPointer<Float64>()
