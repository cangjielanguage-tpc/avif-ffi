...
AVIF_API char * versionString();
AVIF_API char * resultToString(int result);
AVIF_API avifBool isAvifImage(uint8_t *address, int length);
...
AVIF_API bool CreateDecoderAndParse(AvifDecoderWrapper* const decoder,const uint8_t* const buffer, int length,int threads);
AVIF_API avifResult AvifImageToBitmap(AvifDecoderWrapper* const decoder,uint8_t* bitmap_pixels,uint32_t picwidth,uint32_t picheight,uint32_t stride,uint32_t formatvalue);
AVIF_API avifResult DecodeNextImage(AvifDecoderWrapper* const decoder,uint8_t* pixelmap,uint32_t picwidth,uint32_t picheight,uint32_t stride,uint32_t formatvalue);
AVIF_API avifResult DecodeNthImage(AvifDecoderWrapper* const decoder,uint32_t n,uint8_t* pixelmap,uint32_t picwidth,uint32_t picheight,uint32_t stride,uint32_t formatvalue);
